...
def CLOUDY_data(Lumin,idx,metals,Column_density_order):
    ...
    # 리턴할 값들 딕셔너리에 정리
    result = {
        f'radius_p_{Lumin}_{idx}': radius_p_CIV,
        f'SB_CIV_{Lumin}_{idx}': SB_CIV,
        f'Lumin_CIV_{Lumin}_{idx}': Lumin_CIV,
        f'SB_HeII_{Lumin}_{idx}': SB_HeII,
        f'Lumin_HeII_{Lumin}_{idx}': Lumin_HeII,
        f'SB_Lya_{Lumin}_{idx}': SB_Lya,
        f'Lumin_Lya_{Lumin}_{idx}': Lumin_Lya,
        f'radius_{Lumin}_{idx}': radius,
        f'radius_kpc_{Lumin}_{idx}': radius_kpc,
        f'frac_CIII_{Lumin}_{idx}': CIII_frac,
        f'frac_CV_{Lumin}_{idx}': CV_frac,
        f'frac_HeI_{Lumin}_{idx}': HeI_frac,
        f'frac_HeIII_{Lumin}_{idx}': HeIII_frac,
        f'frac_HI_{Lumin}_{idx}': HI_frac,
        f'frac_HII_{Lumin}_{idx}': HII_frac,
        f'ne_{Lumin}_{idx}': n_e,
        f'Te_{Lumin}_{idx}': Mod.te,
        f'Teff_{Lumin}_{idx}': Mod.Teff,
        f'logU_{Lumin}_{idx}': Mod.log_U,
        f'nH_{Lumin}_{idx}': n_H,
        f'frac_CIV_{Lumin}_{idx}': CIV_frac,
        f'emis_CIV_{Lumin}_{idx}': CIV_emis,
        f'nden_CIV_{Lumin}_{idx}': CIV_den,
        f'frac_HeII_{Lumin}_{idx}': HeII_frac,  # 중복 없이 한 번만
        f'emis_HeII_{Lumin}_{idx}': HeII_emis,
        f'nden_HeII_{Lumin}_{idx}': HeII_den ,
        f'Lum_CIV_{Lumin}_{idx}': CIV_Lum,
        f'Lum_HeII_{Lumin}_{idx}': HeII_Lum,
        f'Lum_Lya_{Lumin}_{idx}': Lya_Lum,
        f'Column_density_CIV_{Lumin}_{idx}': CIV_Column_density,
        f'Column_density_HeII_{Lumin}_{idx}': HeII_Column_density,
        f'Column_density_Lya_{Lumin}_{idx}': Lya_Column_density,
        f'Column_density_H_{Lumin}_{idx}': H_Column_density,
    }
