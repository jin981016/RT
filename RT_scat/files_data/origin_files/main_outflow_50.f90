...
v_exp(8)  = 650.d5 
v_exp(9)  = 750.d5      ! cm/s
v_exp(10)  = 850.d5      ! cm/s
v_exp(11)  = 950.d5


v_emit(1)  = 1.d5       ! cm/s
v_emit(2)  = 50.d5       ! cm/s
v_emit(3)  = 150.d5     ! cm/s
v_emit(4)  = 250.d5     ! cm/s
v_emit(5)  = 350.d5
v_emit(6)  = 450.d5     ! cm/s
v_emit(7)  = 550.d5     ! cm/
v_emit(8)  = 650.d5
v_emit(9)  = 750.d5       ! cm/s
v_emit(10)  = 850.d5     ! cm/s
v_emit(11)  = 950.d5     ! cm/s
...
call set_dust('dust_data/MW_C_IV.dat')
	write(fn_model,100) 'data_CIV_V100/N_atom',N_atom(iN_atom), &
